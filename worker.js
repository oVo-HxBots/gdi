...
const authConfig = {
    "siteName": "HxBot - Kirodewal", // Website name
    ...
    "refresh_token": "1//0gPDUymwFev_8CgYIARAAGBASNwF-L9Iroo29b_iCUOih_bKYy3b9iieL7k6l5lR2qFMhDZoA5DCYd32KUQOZ7Vhk2VRFt9EV96Y", // Authorize token
    ...
    "roots":[
      {
          "id": "0AFzUvUCAuiGBUk9PVA",
          "name": "HxBots India",
          "protect_file_link": false,
         // "auth": {"username":"password"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0ANgmS6_jy46GUk9PVA",
          "name": "HxBots",
          "protect_file_link": false,
         // "auth": {"username":"password", "username1":"password1"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0ALqPPh6jyXKgUk9PVA",
          "name": "Movies Cloud Drive",
          "protect_file_link": false,
         // "auth": {"username":"password", "username1":"password1"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AA4xbStIPEapUk9PVA",
          "name": "Hk DriveBot",
          "protect_file_link": false,
         // "auth": {"username":"password", "username1":"password1"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          "id": "0AHQvAQExavaAUk9PVA",
          "name": "TorrentDrive",
          "protect_file_link": false,
         // "auth": {"username":"password", "username1":"password1"} /* Remove double slash before "auth" to activate id password protection */
      },
      {
          ...
          "name": "Drive Two",
          "protect_file_link": false,
         "auth": {"pooran":"saini"} /* Remove double slash before "auth" to activate id password protection */
      },
    ]};
...
const uiConfig = {
    ...
    "logo_link_name": "https://telegra.ph/file/dc6d1abbec8ca02671d9c.jpg",
    ...
    "header_style_class": "navbar-light bg-light", // navbar-dark bg-primary || navbar-dark bg-dark || navbar-light bg-light
    ...
    "company_name": "HxBots", // Name next to copyright
    "company_link": "https://telegram.dog/HxBots", // link of copyright name
    ...
    "unauthorized_owner_link": "https://telegram.dog/HxBots", // Unauthorized Error Page Link to Owner
    "unauthorized_owner_email": "abuse@hxbots.in.eu.org", // Unauthorized Error Page Owner Email
